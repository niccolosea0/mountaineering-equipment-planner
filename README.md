# Mountaineering Equipment Planner
...
- `styles.css` — responsive outdoor visual system, dark theme, and print layout
- `app.js` — tracker data, local persistence, cost and priority updates, and recommendations
